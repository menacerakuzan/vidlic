...
export class AiProviderService {
  ...
  private buildManagerSubmissionPrompt(input: ManagerSubmissionInput): string {
    return [
      ...
      '10. КРИТИЧНО: зберігай ВСЮ конкретику з вхідних даних — назви документів, заходів, нормативних актів, цифри, дати, прізвища відповідальних. Не узагальнюй і не скорочуй конкретні факти.',
      '11. Обʼєднуй лише абсолютно ідентичні пункти (слово в слово). Схожі за темою пункти — НЕ обʼєднуй, зберігай кожен окремо зі своєю специфікою.',
