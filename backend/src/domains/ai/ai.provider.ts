...
export class AiProviderService {
  ...
  private buildManagerSubmissionPrompt(input: ManagerSubmissionInput): string {
    return [
      ...
      '6. Для зведених звітів обовʼязково роби окремий блок по кожному відділу.',
      '7. Якщо є кілька джерел з одного й того ж відділу — ОБʼЄДНУЙ в один спільний блок, не дублюй назву відділу.',
      '8. Заборонено повторювати один і той самий відділ/сектор двічі в документі.',
      '9. У кожному блоці зведення обовʼязково вказуй:',
      '   - "Відділ: <назва>";',
      '   - "Відповідальний: <ПІБ>";',
      ...
      '   - окремий розділ на кожен відділ;',
      '   - у кожному розділі: "Виконана робота", "Проблеми/ризики", "Наступні кроки".',
