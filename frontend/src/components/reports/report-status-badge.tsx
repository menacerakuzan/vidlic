...
const statusMap: Record<string, { label: string; className: string }> = {
  ...
  pending_manager: { label: 'Фінальне погодження керівника', className: 'bg-amber-200 text-amber-800' },
  pending_clerk: { label: 'На погодженні у діловода', className: 'bg-violet-200 text-violet-800' },
  pending_director: { label: 'На погодженні у директора', className: 'bg-indigo-200 text-indigo-800' },
